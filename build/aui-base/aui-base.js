		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-datepicker-deprecated': {submodules: {'aui-datepicker-select-deprecated': {skinnable:true, requires:['aui-datepicker-base-deprecated','aui-button-item']}, 'aui-datepicker-base-deprecated': {skinnable:true, requires:['aui-calendar','aui-overlay-context']} }, use:['aui-datepicker-base-deprecated','aui-datepicker-select'], skinnable:true},
