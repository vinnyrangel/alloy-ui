...
}, '@VERSION@' ,{requires:['aui-base','aui-overlay-base','event-resize'], skinnable:false});


AUI.add('aui-overlay', function(A){}, '@VERSION@' ,{skinnable:false, use:['aui-overlay-base','aui-overlay-context','aui-overlay-context-panel','aui-overlay-manager','aui-overlay-mask']});
